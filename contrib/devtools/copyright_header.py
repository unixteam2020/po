...
# Copyright (c) 2018-2019 The Sombe developers
...
UPDATE_USAGE = """
Updates all the copyright headers of "The Sombe developers" which were
changed in a year more recent than is listed. For example:

// Copyright (c) <firstYear>-<lastYear> The Sombe developers

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> The Sombe developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The Sombe developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The Sombe developers
...
CPP_HEADER = '''
// Copyright (c) %s The Sombe developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Sombe developers'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "The Sombe developers" at the top of the
...
If the file already has a copyright for "The Sombe developers", the
script will exit.
