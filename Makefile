...
pkgdatadir = $(datadir)/Sombe
pkgincludedir = $(includedir)/Sombe
pkglibdir = $(libdir)/Sombe
pkglibexecdir = $(libexecdir)/Sombe
...
CONFIG_HEADER = $(top_builddir)/src/config/Sombe-config.h
CONFIG_CLEAN_FILES = libbitcoinconsensus.pc share/setup.nsi \
	share/qt/Info.plist contrib/devtools/split-debug.sh \
	doc/Doxyfile
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/Sombe-config.h.in COPYING INSTALL \
...
ACLOCAL = ${SHELL} /home/unix/Desktop/new_sombe-1.1/po/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/unix/Desktop/new_sombe-1.1/po/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/unix/Desktop/new_sombe-1.1/po/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/unix/Desktop/new_sombe-1.1/po/build-aux/missing automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
BITCOIN_CLI_NAME = Sombe-cli
BITCOIN_DAEMON_NAME = Sombed
BITCOIN_GUI_NAME = Sombe-qt
BITCOIN_TX_NAME = Sombe-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/unix/Desktop/new_sombe-1.1/po/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = Sombe
PACKAGE_BUGREPORT = https://github.com/Sombe-project/Sombe/issues
PACKAGE_NAME = Sombe
PACKAGE_STRING = Sombe 1.1.0
PACKAGE_TARNAME = Sombe
PACKAGE_URL = https://Sombe.org/
...
ZMQ_LIBS = -lzmq
abs_builddir = /home/unix/Desktop/new_sombe-1.1/po
abs_srcdir = /home/unix/Desktop/new_sombe-1.1/po
abs_top_builddir = /home/unix/Desktop/new_sombe-1.1/po
abs_top_srcdir = /home/unix/Desktop/new_sombe-1.1/po
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/unix/Desktop/new_sombe-1.1/po/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/Sombe-cli.bash-completion \
	       $(top_srcdir)/contrib/Sombe-tx.bash-completion \
	       $(top_srcdir)/contrib/Sombed.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/Sombe.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/Sombe16.xpm \
  $(top_srcdir)/share/pixmaps/Sombe32.xpm \
  $(top_srcdir)/share/pixmaps/Sombe128.png
...
COVERAGE_INFO = baseline.info \
  test_Sombe_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_Sombe_coverage.info test_Sombe.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Sombe-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/Sombe-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/Sombe-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/Sombe-config.h
$(top_srcdir)/src/config/Sombe-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/Sombe-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Sombe-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Sombe-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Sombe-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_Sombe.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_Sombe -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_Sombe_filtered.info: test_Sombe.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_Sombe_filtered.info
...
#test_Sombe_coverage.info: baseline_filtered.info test_Sombe_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_Sombe_filtered.info -o $@

#total_coverage.info: test_Sombe_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_Sombe_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_Sombe.coverage/.dirstamp:  test_Sombe_coverage.info
...
#cov: test_Sombe.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_Sombe.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
