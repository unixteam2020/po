Contributing to Poriun Coin
============================

The Poriun Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/poriun-project/poriun/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Poriun Coin project, and is not to be
confused with overall Poriun Network Protocol consensus changes.

Whether a pull request is merged into Poriun Coin rests with the project merge
...
Patches that change Poriun consensus rules are considerably more involved than
...
Where a patchset proposes to change the Poriun consensus, it must have been
...
The project leader is the release manager for each Poriun Coin release.
