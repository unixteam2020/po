...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Poriun Coin poriun-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  poriun-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded poriun transaction") + "\n" +
                               "  poriun-tx [options] -create [commands]   " + _("Create hex-encoded poriun transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded poriun transaction
