...
static const CAmount DEFAULT_MIN_STAKE_SPLIT_THRESHOLD = 10 * COIN;
...
enum WalletFeature {
    ...
    FEATURE_PRE_Poriun = 61000, // inherited version..
...
public:
    ...
    /// Get 10000 BPR output and keys which can be used for the Masternode
