...
#include "qt/poriun/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/poriun/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(PoriunGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Poriun Coin RPC console.") + "<br>" +
