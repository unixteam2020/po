...
#include "qt/poriun/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/poriun/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(PoriunGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &PoriunGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
