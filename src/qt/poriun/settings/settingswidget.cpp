...
#include "qt/poriun/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(PoriunGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &PoriunGUI::openFAQ);
