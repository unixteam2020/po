...
#include "qt/poriun/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(PoriunGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Poriun_tx_csv_export(*.csv)") : tr("Poriun_addresses_csv_export(*.csv)"),
                                        nullptr);
