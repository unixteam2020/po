...
#include "qt/poriun/settings/settingsnetworkwidget.h"
#include "qt/poriun/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/poriun/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(PoriunGUI* _window, QWidget *parent) :
