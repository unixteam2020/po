...
#include "qt/poriun/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/poriun/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PoriunGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PoriunGUI::handleRestart()
