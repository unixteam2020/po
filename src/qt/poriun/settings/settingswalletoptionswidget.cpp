...
#include "qt/poriun/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/poriun/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(PoriunGUI* _window, QWidget *parent) :
