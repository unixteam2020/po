...
#ifndef Poriun_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Poriun_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Poriun_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
