...
#include "qt/poriun/forms/ui_addresseswidget.h"
#include "qt/poriun/addresslabelrow.h"
#include "qt/poriun/addnewaddressdialog.h"
#include "qt/poriun/tooltipmenu.h"

#include "qt/poriun/addnewcontactdialog.h"
...
AddressesWidget::AddressesWidget(PoriunGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination bprAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(bprAdd, label.toUtf8().constData(),
