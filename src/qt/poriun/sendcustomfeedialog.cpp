...
#include "qt/poriun/sendcustomfeedialog.h"
#include "qt/poriun/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(PoriunGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &PoriunGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
