...
#include "qt/poriun/forms/ui_topbar.h"
#include "qt/poriun/lockunlock.h"
#include "qt/poriun/qtutils.h"
#include "qt/poriun/receivedialog.h"
...
TopBar::TopBar(PoriunGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Poriun")
    updateDisplayUnit();
