...
#ifndef Poriun_CORE_NEW_GUI_PoriunGUI_H
#define Poriun_CORE_NEW_GUI_PoriunGUI_H
...
#include "qt/poriun/navmenuwidget.h"
#include "qt/poriun/topbar.h"
#include "qt/poriun/dashboardwidget.h"
#include "qt/poriun/send.h"
#include "qt/poriun/receivewidget.h"
#include "qt/poriun/addresseswidget.h"
#include "qt/poriun/coldstakingwidget.h"
#include "qt/poriun/masternodeswidget.h"
#include "qt/poriun/snackbar.h"
#include "qt/poriun/settings/settingswidget.h"
...
/**
  Poriun GUI main class. This class represents the main window of the Poriun UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PoriunGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PoriunGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PoriunGUI();
...
#endif //Poriun_CORE_NEW_GUI_PoriunGUI_H
