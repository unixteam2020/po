...
#include "qt/poriun/forms/ui_masternodeswidget.h"

#include "qt/poriun/qtutils.h"
#include "qt/poriun/mnrow.h"
#include "qt/poriun/mninfodialog.h"
#include "qt/poriun/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/poriun/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(PoriunGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 10000)) {
        inform(tr("Not enough balance to create a masternode, 10000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
