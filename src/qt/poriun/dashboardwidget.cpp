...
#include "qt/poriun/forms/ui_dashboardwidget.h"
#include "qt/poriun/sendconfirmdialog.h"
#include "qt/poriun/txrow.h"
...
DashboardWidget::DashboardWidget(PoriunGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &PoriunGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &PoriunGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &PoriunGUI::openFAQ);
...
void DashboardWidget::changeChartColors()
{
    ...
    if (isLightTheme()) {
        ...
        gridLineColorX = QColor(11, 18, 22);
        linePenColorY =  gridLineColorX;
        backgroundColor = linePenColorY;
    }
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(6, 137, 196));
