...
#include "qt/Sombe/forms/ui_dashboardwidget.h"
#include "qt/Sombe/sendconfirmdialog.h"
#include "qt/Sombe/txrow.h"
...
DashboardWidget::DashboardWidget(SombeGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &SombeGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &SombeGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &SombeGUI::openFAQ);
