...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, SombeGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, SombeGUI* gui, double posX = 3);
