...
#include "qt/Sombe/settings/settingsnetworkwidget.h"
#include "qt/Sombe/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/Sombe/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SombeGUI* _window, QWidget *parent) :
