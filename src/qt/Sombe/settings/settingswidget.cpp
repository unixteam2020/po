...
#include "qt/Sombe/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(SombeGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &SombeGUI::openFAQ);
