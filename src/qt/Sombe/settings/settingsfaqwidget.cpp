...
#include "qt/Sombe/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/Sombe/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(SombeGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &SombeGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
