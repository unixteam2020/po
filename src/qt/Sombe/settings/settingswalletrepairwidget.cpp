...
#include "qt/Sombe/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/Sombe/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SombeGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SombeGUI::handleRestart()
