...
#include "qt/Sombe/forms/ui_masternodeswidget.h"

#include "qt/Sombe/qtutils.h"
#include "qt/Sombe/mnrow.h"
#include "qt/Sombe/mninfodialog.h"
#include "qt/Sombe/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/Sombe/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(SombeGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:2117 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 2000000)) {
        inform(tr("Not enough balance to create a masternode, 2000000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
