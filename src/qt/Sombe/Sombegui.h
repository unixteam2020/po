...
#ifndef Sombe_CORE_NEW_GUI_SombeGUI_H
#define Sombe_CORE_NEW_GUI_SombeGUI_H
...
#include "qt/Sombe/navmenuwidget.h"
#include "qt/Sombe/topbar.h"
#include "qt/Sombe/dashboardwidget.h"
#include "qt/Sombe/send.h"
#include "qt/Sombe/receivewidget.h"
#include "qt/Sombe/addresseswidget.h"
#include "qt/Sombe/coldstakingwidget.h"
#include "qt/Sombe/masternodeswidget.h"
#include "qt/Sombe/snackbar.h"
#include "qt/Sombe/settings/settingswidget.h"
...
/**
  Sombe GUI main class. This class represents the main window of the Sombe UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SombeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SombeGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SombeGUI();
...
#endif //Sombe_CORE_NEW_GUI_SombeGUI_H
