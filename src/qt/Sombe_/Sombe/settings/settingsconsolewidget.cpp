...
#include "qt/Sombe/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/Sombe/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SombeGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Sombe Coin RPC console.") + "<br>" +
