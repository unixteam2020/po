                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Poriun Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Poriun Coin"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #0689c4;text-decoration:none'  href=\"\\1\">\\1</a>");
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Poriun is shutting down...") + "<br /><br />" +
