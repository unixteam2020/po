...
- [Development guidelines](#development-guidelines)
    - [General Sombe](#general-Sombe-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Sombe uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Sombe is a multi-threaded application, and deadlocks or other
...
However, in open source software such as Sombe, where everyone uses
...
pay attention to for reviewers of Sombe code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Sombe uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Sombe so that they can be integrated
