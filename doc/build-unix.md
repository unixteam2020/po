UNIX BUILD NOTES
====================
Some notes on how to build Sombe Coin in Unix.

Note
---------------------
Always use absolute paths to configure and compile Sombe Coin and the dependencies,
...
memory available when compiling Sombe Coin. On systems with less, gcc can be
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~Sombe/+archive/Sombe).
 You can add the repository using the following command:

    sudo apt-get install software-properties-common
    sudo add-apt-repository ppa:Sombe/Sombe
    sudo apt-get update
...
To build Sombe Coin without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Sombe Coin installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Sombe Coin should be built with a non-executable stack
