...
The build script we'll be using is contained in the Poriun github repository ([contrib/gitian-build.py](https://github.com/poriun-project/poriun/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Poriun repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Poriun-Project/Poriun/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, poriun-detached-sigs, and poriun GitHub repos.
