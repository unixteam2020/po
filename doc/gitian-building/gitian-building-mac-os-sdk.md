...
The script [extract-osx-sdk.sh](https://github.com/poriun-project/poriun/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
poriun/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/poriun-project/poriun/blob/master/doc/README_osx.md) for troubleshooting tips.
