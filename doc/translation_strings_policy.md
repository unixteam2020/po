...
This document provides guidelines for internationalization of the Poriun Coin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `poriun_en.ts` remains unchanged.
